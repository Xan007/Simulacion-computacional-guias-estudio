...
| **08** | [**08. Ejercicios Resueltos del Libro de Texto**](./08_EJERCICIOS_LIBRO_SHELDON_ROSS.md) | Ejercicios oficiales extraídos directamente del libro de Sheldon Ross (Capítulos 3 y 4) con solución paso a paso, razonamiento detallado y criterios de decisión sin emojis. |
