...
> ⏱️ **Eficiencia:** El número promedio de iteraciones necesarias para generar una variable es exactamente igual a la constante $c$. Por ello, se busca que $c$ sea lo más cercana a $1$ posible.
