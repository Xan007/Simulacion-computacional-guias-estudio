...
| **08** | [**08. Ejercicios Resueltos del Libro de Texto**](./08_EJERCICIOS_LIBRO_SHELDON_ROSS.md) | Ejercicios oficiales extraídos directamente de los libros de Jerry Banks (Capítulo 1) y Sheldon Ross (Capítulos 3 y 4) con solución paso a paso, razonamiento detallado y criterios de decisión sin emojis. |
| **09** | [**09. Guía Didáctica Detallada del Capítulo 4**](./09_GUIA_DIDACTICA_CAPITULO_4_EXPLICADA.md) | Explicación intuitiva paso a paso del Capítulo 4 (Transformada Inversa Discreta Eficiente, Composición y Suma de Geométricas) diseñada con lenguaje sencillo, analogías y tabla de decisión para exámenes. |
